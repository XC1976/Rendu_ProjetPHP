...
Personal restrictions for practice :
- As close to 100% MVC and object only as possible with close to zero procedural programming.
- Apply big projects good practices even if it is not useful for a little project :
  - includes to not reuse code
  - $ROOTPATH variable to avoid having path breakage
  - Usage of namespace
  - and more
